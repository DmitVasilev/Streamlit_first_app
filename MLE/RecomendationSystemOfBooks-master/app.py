...
def read_files(folder_name='data'):
    ...
    """
    ratings = pd.read_csv(folder_name + '/ratings.zip', compression='zip')
...
# небольшое описание нашего приложения и инструкцию по работе с ним
...
if option:
    ...
    fig = px.bar(
        ...
        title='Cosine distance to the nearest books', color = 'book_author'
    )
